...
<header class="admin-topbar fixed top-0 right-0 z-40 transition-all duration-500 bg-white/80 dark:bg-gray-950/80 backdrop-blur-xl border-b border-gray-100 dark:border-gray-800"
    ...
    <div class="px-4 md:px-8 py-2 md:py-3.5 flex items-center justify-between gap-3 md:gap-4">
        ...
        <div class="flex items-center gap-2 md:gap-3" x-data="{ profileOpen: false, notifOpen: false }" @keydown.escape.window="profileOpen = false; notifOpen = false">
            ...
            <button
                ...
                class="hidden xl:flex w-10 h-10 rounded-xl border border-gray-200 dark:border-gray-800 items-center justify-center text-gray-500 dark:text-gray-400 hover:text-blue-600 transition shrink-0"
            >
            ...
            <div class="relative">
                ...
                <div
                    ...
                    class="absolute right-0 mt-3 w-80 max-w-[calc(100vw-2rem)] rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-2xl overflow-hidden z-[50]"
            ...
            <div class="relative">
                ...
                <div
                    ...
                    class="absolute right-0 mt-3 w-56 max-w-[calc(100vw-2rem)] rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-2xl overflow-hidden z-[50]"
                    x-transition:enter="transition ease-out duration-200"
                    x-transition:enter-start="opacity-0 translate-y-2 scale-95"
                    x-transition:enter-end="opacity-100 translate-y-0 scale-100"
                >
