...
<div class="space-y-6 pb-20">
    ...
    <form method="POST" action="{{ route('admin.produk.store') }}" enctype="multipart/form-data" class="space-y-6" x-data="{ isSubmitting: false }" @submit="isSubmitting = true">
        @csrf
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" placeholder="Jelaskan detail produk Anda..."
                        class="w-full bg-gray-50/80 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10 focus:bg-white dark:focus:bg-gray-900 rounded-xl outline-none transition-all duration-300 text-sm font-medium"
                        :readonly="isSubmitting">{{ old('description') }}</textarea>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm p-6 space-y-5">
                ...
                <div class="flex flex-col gap-3 pt-2">
                    <label class="flex items-center gap-3 cursor-pointer group" :class="isSubmitting ? 'opacity-50 pointer-events-none' : ''">
                        <div class="relative">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm" :class="isSubmitting ? 'opacity-50 pointer-events-none' : ''">
                <div class="p-6 border-b border-gray-100 dark:border-gray-800">
        ...
        <div class="fixed bottom-0 right-0 z-[100] transition-all duration-300 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-t border-gray-200 dark:border-gray-800 p-4"
            ...
            <div class="flex flex-row items-center justify-end gap-2 sm:gap-3 px-3 sm:px-6">
                ...
                <button type="submit" name="action" value="save_and_another" class="flex-1 sm:flex-none px-4 sm:px-6 py-2.5 rounded-xl border border-blue-600 text-blue-600 text-[10px] sm:text-sm font-bold hover:bg-blue-50 transition text-center whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
                    :disabled="isSubmitting">
                    <span x-show="!isSubmitting">Simpan & Buat Lagi</span>
                    <span x-show="isSubmitting">Memproses...</span>
                </button>
                <button type="submit" class="flex-1 sm:flex-none px-6 sm:px-10 py-2.5 rounded-xl bg-blue-600 text-white text-[10px] sm:text-sm font-bold hover:bg-blue-700 transition shadow-lg shadow-blue-200 dark:shadow-none text-center whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
                    :disabled="isSubmitting">
