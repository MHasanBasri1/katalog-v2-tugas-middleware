...
<div class="space-y-6 pb-20">
    ...
    <nav class="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-gray-400 mb-6">
        ...
        <span class="text-gray-900 dark:text-white font-black">Pengaturan Situs</span>
    </nav>

    @if (session('status'))
        <div class="rounded-xl border border-emerald-200 bg-emerald-50 text-emerald-700 px-4 py-3 text-sm font-semibold flex items-center gap-3 animate-in fade-in slide-in-from-top-4 duration-300 shadow-sm shadow-emerald-100 dark:shadow-none">
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div class="pt-6 border-t border-gray-100 dark:border-gray-800 flex flex-wrap gap-4">
                            <div class="flex-1 space-y-1.5">
                                <label class="block text-[10px] font-black text-pink-600 uppercase tracking-widest">Instagram</label>
                            ...
                            <div class="flex-1 space-y-1.5">
                                <label class="block text-[10px] font-black text-blue-700 uppercase tracking-widest">Facebook</label>
