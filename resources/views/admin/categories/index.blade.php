        ...
        x-data="{
            ...
            submitBulkDelete() {
                ...
                $store.confirm.open({
                    ...
                    message: `Apakah Anda yakin ingin menghapus ${this.selectedIds.length} kategori yang dipilih?`,
            ...
            <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 shadow-sm">
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a href="{{ route('admin.kategori.create') }}" class="px-6 py-2.5 rounded-xl bg-blue-600 text-white text-sm font-bold hover:bg-blue-700 transition shadow-sm flex items-center gap-2">
                ...
                <form method="GET" action="{{ route('admin.kategori.index') }}" class="mt-8 pt-6 border-t border-gray-100 dark:border-gray-800 flex flex-wrap items-end gap-4">
                    <div class="flex-1 min-w-[300px]" x-data="{ q: '{{ request('q') }}' }">
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" name="q" x-model="q" placeholder="Cari nama kategori..." 
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <form method="POST" action="{{ route('admin.kategori.destroy', $category) }}" x-ref="deleteForm{{ $category->id }}">
                                                @csrf
                                                @method('DELETE')
                                                <button 
                                                    type="button" 
                                                    @click="$store.confirm.open({
                                                        ...
                                                        message: 'Hapus kategori ini? Semua produk dalam kategori ini tidak akan memiliki kategori.',
